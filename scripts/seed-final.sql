-- Final seed script with correct enum values
DO $$
DECLARE
...
BEGIN
  ...
  -- transaction_type: sale, transfer, lease, mortgage, gift
  ...
  VALUES
    ...
    ('TXN-2024-003', p2, 101, 101, 'sale', 'completed', 500000, 'NGN', '0xabcdef1234567890abcdef1234567890abcdef1234567890abcdef1234567890', NOW() - INTERVAL '4 months', NOW() - INTERVAL '3 months', NOW() - INTERVAL '4 months', NOW()),
    ...
    ('TXN-2024-005', p3, 102, 100, 'gift', 'cancelled', 0, 'NGN', NULL, NOW() - INTERVAL '1 month', NULL, NOW() - INTERVAL '1 month', NOW())
