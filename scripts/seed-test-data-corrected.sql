-- IDLR-PTS Test Data Seed Script (Corrected for actual schema)
...
BEGIN
  ...
  SELECT id INTO parcel5_id FROM parcels WHERE parcel_id = 'LG-IKJ-2024-005';
  ...
  INSERT INTO transactions (
    ...
    transaction_type, status, amount, payment_status,
